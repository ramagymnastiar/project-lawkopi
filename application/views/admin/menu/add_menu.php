<div class="conatiner">
    <form action="<?php echo base_url().'admin/menu/create_menu';?>" method="POST" id="myForm" name="myForm"
        ...
        <h3 class="mb-3 text-center">Tambah Makanan</h3>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('name') != "") ? 'is-invalid' : '';?>" name="name" id="name"
                        placeholder="Masukan Nama Makanan" value="<?php echo set_value('name'); ?>">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="about">Deskripsi Makanan</label>
                    <input type="text" class="form-control my-2
                    <?php echo (form_error('about') != "") ? 'is-invalid' : '';?>" id="about" name="about"
                        placeholder="Tentang Makanan" value="<?php echo set_value('about'); ?>">
        ...
        <button type="submit" class="btn btn-primary ml-2">Buat</button>
