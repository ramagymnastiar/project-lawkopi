...
<div class="container">
    ...
    <div class="table-responsive-sm">
        <table class="table table-striped table-hover">
            ...
            <tfoot>
                <tr>
                    <td><a href="<?php echo base_url().'dish/list/1' ?>" class="btn btn-sm btn-warning"><i class="fas fa-angle-left"></i> Lanjut Pesanan</a></td>
                    <td colspan="3"></td>
                    <?php  if($this->cart->total_items() > 0) { ?>
                    <td class="text-left">Grand Total: <b><?php echo 'Rp.'.$this->cart->total();?></b></td>
                    <td><a href="<?php echo base_url().'checkout';?>" class="btn btn-sm btn-success btn-block">Lanjut Pembayaran <i class="fas fa-angle-right"></i></a></td>
                    <?php } ?>
                </tr>            </tfoot>
        </table>
    </div>
