<div class="conatiner">
    ...
    <form action="<?php echo base_url().'admin/user/create_user'; ?>" method="POST"
        ...
        <h3 class="mb-3 p-2 text-center">Tambah Users</h3>
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="firstname">Masukan Nama Depan</label>
                    <input type="text" class="form-control
                    <?php echo (form_error('firstname') != "") ? 'is-invalid' : '';?>" name="firstname" id="firstName"
                        placeholder="Masukan Nama Depan" value="<?php echo set_value('firstname')?>">
                    <?php echo form_error('firstname'); ?>
                    <span></span>
                </div>
                <div class="form-group">
                    <label for="lastname">Masukan Nama Belakang</label>
                    <input type="text" class="form-control 
                    <?php echo (form_error('lastname') != "") ? 'is-invalid' : '';?>" name="lastname" id="lastName"
                        placeholder="Masukan Nama Belakang" value="<?php echo set_value('lastname')?>">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <?php echo (form_error('phone') != "") ? 'is-invalid' : '';?>" name="phone" placeholder="No.Telp"
